...
export default async function BlogDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="mt-16 p-8">
      <p>
        <strong className="mr-3">ID:</strong> {blog.id}
      </p>
      <p>
        <strong className="mr-3">タイトル:</strong> {blog.title}
      </p>
      <p>
        <strong className="mr-3">内容:</strong> {blog.content}
      </p>
      <p>
        <strong className="mr-3">作成日:</strong>
